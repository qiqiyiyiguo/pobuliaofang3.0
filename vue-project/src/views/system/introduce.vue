...
.introduce-page {
  ...
  padding: 24px;
  background:
    radial-gradient(circle at 18% 20%, rgba(26, 202, 255, 0.14), transparent 20%),
    radial-gradient(circle at 80% 16%, rgba(130, 79, 255, 0.24), transparent 24%),
    radial-gradient(circle at 75% 82%, rgba(69, 103, 255, 0.2), transparent 26%),
    linear-gradient(135deg, #0b1226 0%, #101933 38%, #1a2147 70%, #0d1730 100%);
  color: #f6f8ff;
}
...
.intro-section {
  ...
  box-shadow: 0 24px 56px rgba(4, 10, 30, 0.36);
...
.summary-card {
  border-radius: 20px;
  padding: 20px;
  background: linear-gradient(135deg, rgba(95, 220, 255, 0.18), rgba(115, 81, 255, 0.3)), linear-gradient(135deg, #34437f 0%, #4b3693 100%);
  color: #fff;
...
.nav-progress-bar {
  ...
  background: linear-gradient(180deg, #6dd7ff 0%, #7351ff 100%);
...
.intro-content::-webkit-scrollbar-thumb {
  border-radius: 999px;
  background: rgba(138, 151, 255, 0.35);
}
